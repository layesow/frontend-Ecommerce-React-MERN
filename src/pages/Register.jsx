      ...
      <div className="max-w-md w-full rounded-md px-8 py-7 shadow-md bg-white">
        ...
        <form className="space-y-4 mt-4">
          <div className="flex flex-col space-y-2">
            ...
            <input type="text" id="name" className="border border-gray-200 rounded-md shadow px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400" placeholder="Enter your name"/>
          </div>
          ...
          <div className="flex flex-col space-y-2">
            ...
            <input type="password" id="confirmPassword" className="border border-gray-200 rounded-md shadow px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400" placeholder="Enter your password"/>
          </div>
